...
#python $*
mpirun -np 16 --use-hwthread-cpus --oversubscribe python -u train.py --env-name='FetchReach-v1' --n-cycles=10 2>&1 | tee reach.log
#python -u train.py --env-name='FetchReach-v1' --n-cycles=10 2>&1 | tee reach.log
"
