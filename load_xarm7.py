...
class FetchEnv(RobotEnv):
    ...
    def _set_action(self, action):
        ...
        print(f"{pos_ctrl} Position control | {gripper_ctrl} Gripper Ctrl")
...
class FetchReachEnv(FetchEnv, utz.EzPickle):
...
env = FetchReachEnv(xml_path=reach_combined_gripper)
