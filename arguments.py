...
def get_args():
    ...
    parser.add_argument('--bc-dataset-path', type=str, default='/misc/kcgscratch1/karan_exp/offline_dataset', help='the path to save the models')
    parser.add_argument('--noise-eps', type=float, default=0.2, help='noise eps')
    parser.add_argument('--random-eps', type=float, default=0.3, help='random eps')
    parser.add_argument('--buffer-size', type=int, default=int(1e4), help='the size of the buffer')
    ...
    parser.add_argument('--loadsaved', action='store_true', help='load saved model')
