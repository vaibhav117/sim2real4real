...
mpiexec --oversubscribe --use-hwthread-cpus -n 4 /misc/kcgscratch1/karan_exp/miniconda3/envs/dmc/bin/python -u train.py --cuda --depth --plottrain --record --randomize --env-name='FetchPickAndPlace-v1' --mode='reach' | tee fetch_pick_and_place.log 
