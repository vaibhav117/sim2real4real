...
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/share/apps/openmpi/2.0.1/intel/lib:/share/apps/intel/17.0.1/mkl/lib/intel64:/share/apps/intel/17.0.1/lib/intel64:/share/apps/centos/7/usr/lib64:/opt/slurm/lib64:/home/ksc487/.mujoco/mujoco200/bin:/share/apps/centos/7/usr/lib64:/opt/slurm/lib64:/home/ksc487/.mujoco/mujoco200/bin
...
nvidia-smi
mpirun -np 1 --use-hwthread-cpus --oversubscribe python -u train.py --cuda --env-name='FetchReach-v1' --n-cycles=10 2>&1 | tee reach.log
"
