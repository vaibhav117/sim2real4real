...
mpiexec --oversubscribe --use-hwthread-cpus -n 1 /misc/kcgscratch1/karan_exp/miniconda3/envs/dmc/bin/python -u collect_data.py --record --scripted --task asym_goal_outside_image --bc-dataset-path /misc/kcgscratch1/karan_exp/dagger_dataset --n-batches 10
